                    ...
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-6">
                                ...
                                <input type="text" placeholder="Location" id="location" name="location" class="form-control"> <!-- Ensure name is "location" -->
                        ...
                        <div class="col-md-6  mb-4">
                         <label for="" class="mb-2">Expericence<span class="req">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-6">
                                <label for="location" class="mb-2">Location<span class="req">*</span></label>
                                <input type="text" placeholder="Location" id="company_location" name="company_location" class="form-control"> <!-- Ensure name is "location" -->
                                <p class="invalid-feedback"></p>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" placeholder="https://example.com" id="company_website" name="company_website" class="form-control" pattern="https?://.+" title="Please enter a valid URL starting with http:// or https://">
                        </div>
                    </div> 
