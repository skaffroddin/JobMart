    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="{{ route('admin.jobs.update', ['id' => $job->id]) }}" method="post" name="editJobForm" id="editJobForm">
                    @csrf
                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="form-check">
                                    <input {{($job->isFeatured ==0) ? 'checked' : ''}} class="form-check-input" type="checkbox" value="1" id="isFeatured" name="isFeatured">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="experience" id="experience" class="form-control">
                                   ...
                                   <option value="2" {{ ($job->experience == 2) ? 'selected' : '' }}>2</option>
                                   <option value="3" {{ ($job->experience == 3) ? 'selected' : '' }}>3</option>
                                   <option value="4" {{ ($job->experience == 4) ? 'selected' : '' }}>4</option>
                                   <option value="5" {{ ($job->experience == 5) ? 'selected' : '' }}>5</option>
                                   <option value="6" {{ ($job->experience == 6) ? 'selected' : '' }}>6</option>
                                   <option value="7" {{ ($job->experience == 7) ? 'selected' : '' }}>7</option>
                                   <option value="8" {{ ($job->experience == 8) ? 'selected' : '' }}>8</option>
                                   <option value="9" {{ ($job->experience == 9) ? 'selected' : '' }}>9</option>
                            ...
                            <div class="mb-4">
                                ...
                                <input value="{{$job->company_website}}" type="url" placeholder="https://example.com" id="company_website" name="company_website" class="form-control" pattern="https?://.+" title="Please enter a valid URL starting with http:// or https://">
                            </div>
                        </div> 
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === true) {
                    $("#title, #category, #jobType, #vacancy, #location, #description, #company_name").each(function() {
                    ...
                    if (errors.vacancy) {
                        $("#vacancy").addClass('is-invalid')
                            .siblings('p').addClass('invalid-feedback').html(errors.vacancy);
                    } else {
                    ...
                    if (errors.location) {
                        $("#location").addClass('is-invalid')
                            .siblings('p').addClass('invalid-feedback').html(errors.location);
                    } else {
                    ...
                    if (errors.company_name) {
                        $("#company_name").addClass('is-invalid')
                            .siblings('p').addClass('invalid-feedback').html(errors.company_name);
                    } else {
